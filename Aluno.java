...
public class Aluno extends Pessoa {
        ...
        public Aluno(String nome, String apelido, int numescolar, LocalDateTime nascimento, String disciplina, int nif, String email, int anoescolar) {
			...
			public static aluno novoAluno() {
				...
				return new Aluno (pessoa.getNome(), pessoa.getApelido(), pessoa.getNumescolar(), pessoa.getNascimento(), disciplina , NIF);
			}
			
			public String tostring(){
				return super.toString() + String.format("Disciplina %s:, NIF %d:", disciplina, NIF ); 
